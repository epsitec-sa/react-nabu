  ...
  _createClass(NabuText, [{
    ...
    value: function mustAdd(props) {
      ...
      if (mustAdd) {
        ...
        dispatch((0, _reduxNabu.addMessage)(msgid, desc));
      }
    }
  }, {
    ...
    value: function render() {
      ...
      var fallbackMessage = (0, _immutable.fromJS)({
        id: msgid,
        defaultMessage: msgid,
        description: desc
      });

      var message = messages.get(msgid, fallbackMessage).toJS();

      var text = html ? formatHTMLMessage(message, values) : formatMessage(message, values);
